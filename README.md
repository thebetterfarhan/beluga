...
Balooga is an Android TV launcher designed for accessibility. It can be used as a replacement for the default
Leanback or Google TV launcher on various Android TV devices like the Nvidia Shield or Chromecast with Google TV.

The app is fully accessible via D-pad and TalkBack.
